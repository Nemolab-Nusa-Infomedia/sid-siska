            ...
            <div class="col-12">
                <div class="card card-form p-3 bg-white mt-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="upload-file d-flex justify-content-center align-items-center bg-primary rounded-3" style="width: 240px; height: 50px;">
                    ...
                    <div class="row col-12 col-md-12 mx-auto">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="" aria-describedby="" value="26-07-2024">
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <label for="inputState" class="form-label">Jenis Penduduk</label>
                            <select id="inputState" class="form-select" value="26-07-2024">
                                <option selected>Jenis penduduk</option>
                                <option>...</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-4">
